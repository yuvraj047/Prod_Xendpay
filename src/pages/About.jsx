    ...
    <div>
      ...
      <section className="border-b border-subtle bg-surfacemuted/40">
        <div className="max-w-content mx-auto px-5 md:px-8 py-14 md:py-16 grid md:grid-cols-2 gap-10">
          <div className="bg-surface border border-subtle rounded-2xl p-8">
            ...
            <p className="font-body text-basetext leading-relaxed">
      ...
      <section>
        <div className="max-w-content mx-auto px-5 md:px-8 py-16 md:py-20">
          ...
          <h2 className="font-display font-semibold text-2xl md:text-3xl text-basetext">Our Values</h2>
          <div className="mt-10 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {VALUES.map((v) => (
              <div key={v.name}>
                <p className="font-display font-semibold text-lg text-basetext">{v.name}</p>
                <p className="mt-2 text-sm text-muted font-body leading-relaxed">{v.copy}</p>
              </div>
            ))}
          </div>
        </div>
