    ...
    <div>
      ...
      <section>
        <div className="max-w-content mx-auto px-5 md:px-8 py-14 md:py-16 grid lg:grid-cols-[1fr_320px] gap-12">
          <div className="bg-paper border border-line rounded-2xl p-6 md:p-10">
            <ContactForm />
          </div>

          <div className="flex flex-col gap-6">
            <div className="bg-panel/50 border border-line rounded-2xl p-6">
              <p className="eyebrow text-inkgrey mb-3">Xendpay Solutions Private Limited</p>
            ...
            <div className="bg-panel/50 border border-line rounded-2xl p-6">
              <p className="eyebrow text-inkgrey mb-3">What Happens Next</p>
              <ul className="flex flex-col gap-2.5 text-sm text-inkgrey font-body leading-relaxed">
